		...
		<div id="show-instituicao" class="content scaffold-show" role="main">
			...
			<ol class="property-list instituicao">
				...
				<li class="fieldcontain">
					<span id="cnpj-label" class="property-label"><g:message code="instituicao.cnpj.label" default="Cnpj" /></span>
					
						<span class="property-value" aria-labelledby="cnpj-label"><g:fieldValue bean="${instituicaoInstance}" field="cnpj"/></span>
				...
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="instituicao.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${instituicaoInstance}" field="descricao"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${instituicaoInstance?.eventos}">
				<li class="fieldcontain">
					<span id="eventos-label" class="property-label"><g:message code="instituicao.eventos.label" default="Eventos" /></span>
			...
			<g:form url="[resource:instituicaoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${instituicaoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

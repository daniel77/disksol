...
<html>
	...
	<body>
		<a href="#show-doador" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-doador" class="content scaffold-show" role="main">
			...
			<ol class="property-list doador">
				...
				<li class="fieldcontain">
					<span id="cidade-label" class="property-label"><g:message code="doador.cidade.label" default="Cidade" /></span>
					
						<span class="property-value" aria-labelledby="cidade-label"><g:fieldValue bean="${doadorInstance}" field="cidade"/></span>
				...
				<li class="fieldcontain">
					<span id="doacoes-label" class="property-label"><g:message code="doador.doacoes.label" default="Doacoes" /></span>
						...
						<span class="property-value" aria-labelledby="doacoes-label"><g:link controller="doacao" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="doador.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${doadorInstance}" field="nome"/></span>
			...
			<g:form url="[resource:doadorInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${doadorInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
